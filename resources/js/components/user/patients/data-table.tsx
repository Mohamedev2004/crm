...
interface PatientDataTableProps<TData> {
  columns: any;
  data: TData[];
  rowSelection: Record<string, boolean>;
  setRowSelection: (
    val: Record<string, boolean> | ((old: Record<string, boolean>) => Record<string, boolean>)
  ) => void;
...
export function PatientDataTable<TData>({
  columns,
  data = [],
  rowSelection,
  setRowSelection,
        ...
        <div className="flex flex-col items-center justify-center py-20">
          <Empty>
            <EmptyHeader>
              ...
              <EmptyDescription>
                Vous n'avez aucun patient pour le moment. Commencez par en ajouter un.
              </EmptyDescription>
            </EmptyHeader>
